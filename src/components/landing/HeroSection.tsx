  ...
  return (
    <main className="bg-[#D1FADF] w-full h-screen max-h-screen overflow-hidden flex flex-col">
      <div className="flex-1 flex flex-col items-center justify-center px-4 sm:px-6 md:px-8 lg:px-10 xl:px-20 mx-auto w-full">
        ...
        <div className="mb-8 sm:mb-10 md:mb-2 mt-10 w-full flex justify-center">
          <Image
            src="/images/logo.svg"
            width={200}
            height={200}
        ...
        <section className="w-full max-w-[1280px] mx-auto flex flex-col items-center justify gap-6 md:gap-8 flex-1 py-4">
          {/* Text Content */}
