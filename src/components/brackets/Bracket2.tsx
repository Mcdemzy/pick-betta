    ...
    <>
      <main>
        ...
        <section className="flex flex-col gap-y-3 ml-10 my-10">
          ...
          <div className="bg-[#D0D0D0B2] w-[200px] absolute h-[2px] left-70 top-[316px]">
          ...
          <div className="bg-[#D0D0D0B2] w-[200px] absolute h-[2px] left-70 top-[418px]">
            <div className="h-[6px] w-[2px] bg-[#D0D0D0B2] relative left-50 bottom-1"></div>
          </div>
          {/*  */}
          {/*  */}
          {/*  */}
          <div className="w-[243px] min-h-[81px] rounded border border-[#E4E7EC] absolute top-[324px] left-90">
            <div className="flex items-center justify-between border border-[#E4E7EC]">
