...
import { parlayItems } from "@/components/shared/data";
      ...
      <main className="min-h-screen bg-white">
        <section className="w-full h-[109px] bg-[#06543C] text-white px-5 pt-8.5 pb-[15px] flex items-center">
          ...
          <p className="text-xl font-semibold leading-6 ml-4">
            <span className="text-[#D8A428]">{league.toUpperCase()}</span> Betta
            Parlay
          </p>
        </section>
        ...
        <section className="p-5">
          <div className="w-full flex flex-col gap-y-2.5">
            {parlayItems.map((item) => (
              ...
              >
                <button
                  className="w-full h-10 p-3.5 flex justify-between items-center cursor-pointer"
      ...
      <div className="ml-[260px]">
        ...
        <div className="w-full px-5 py-6">
          <h1 className="text-xl font-semibold mb-4 text-[#1A1A1A]">
            {league.toUpperCase()} Betta Parlay
          </h1>
          <section>
            <div className="w-full flex flex-col gap-y-2.5">
              {parlayItems.map((item) => (
