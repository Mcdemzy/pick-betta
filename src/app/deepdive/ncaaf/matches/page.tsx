        ...
        <div className="px-6 py-5">
          ...
          <nav className="mb-6">
            <ul className="flex gap-x-5 items-center px-5 py-2 text-[#475467] text-sm">
              ...
              <li>NCAAB</li>
              <li>NHL</li>
              <li className="text-[#06543C] font-semibold">NCAAF</li>
            </ul>
