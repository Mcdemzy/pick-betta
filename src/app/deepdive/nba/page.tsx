  ...
  if (!isDesktop) {
    return (
      <main>
        ...
        {/* Match Details - Keep original table structure */}
        <main className="px-5">
          {/* Your existing table implementation remains completely unchanged */}
  ...
  return (
    <main className="flex min-h-screen bg-white">
      ...
      <div className="flex-1 flex flex-col ml-[260px]">
        ...
        {/* Your existing content wrapped in the desktop container */}
